...
public class DayCard : MonoBehaviour
{
    ...
    public TextMeshProUGUI minTemperature;
    ...
    public void ShowMetric(bool showMetric)
    {
        ...
        temperature.text = ToHumanTemperature(_model.MaximumTemp);
        minTemperature.text = ToHumanTemperature(_model.MinimumTemp);
    }
    ...
    private void Fill()
    {
        ...
        header.text = _model.Header;
        detail.text = _model.Details;
